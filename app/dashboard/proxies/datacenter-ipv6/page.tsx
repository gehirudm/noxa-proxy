...
export default function DatacenterIPv6Page() {
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="flex">
        ...
        <div className="flex-1">
          ...
          <main className="p-6">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-foreground mb-2">Datacenter IPv6 Proxies</h1>
              <p className="text-muted-foreground">High-speed datacenter proxies with IPv6 addresses</p>
            </div>
            ...
            {activeTab === "plans" && (
              <div className="text-center py-12">
                <h3 className="text-xl font-semibold text-foreground mb-2">Datacenter IPv6 Plans</h3>
                <p className="text-muted-foreground">Choose from our datacenter IPv6 proxy plans</p>
              </div>
            )}
          </main>
        </div>
