          ...
          <main className="p-6">
                ...
                <div className="lg:col-span-1 space-y-4">
                  <Card className="bg-card border-border">
                    <CardHeader>
                      ...
                      <div className="text-3xl font-bold text-foreground">0.00 GB</div>
                    </CardHeader>
                  ...
                  <Card className="bg-card border-border">
                    <CardHeader className="flex flex-row items-center justify-between">
                      <div>
                        ...
                        <div className="text-3xl font-bold text-foreground mt-2">0.00 GB</div>
                      </div>
                    ...
                    <CardContent>
                      <div className="h-32 bg-muted rounded flex items-end justify-center">
                        <div className="text-muted-foreground text-sm">Usage data visualization</div>
                      </div>
            ...
            {activeTab === "generator" && (
              <div className="text-center py-12">
                <h3 className="text-xl font-semibold text-foreground mb-2">Proxy Generator</h3>
                <p className="text-muted-foreground">Generate premium residential proxy endpoints</p>
              </div>
            )}
            ...
            {activeTab === "plans" && (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">Choose from our premium residential proxy plans</p>
              </div>
            )}
          </main>
        </div>
